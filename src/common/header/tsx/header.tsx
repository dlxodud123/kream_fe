    ...
    return(
        <header className='header_container'>
            <div className='header_top_container'>
                ...
                <div onClick={() => { navigate('/로그인') }} className='header_top_content'>
                    로그인
                </div>
            </div>
            <div className='header_main_container'>
                <img onClick={() => {navigate('/')}} className='header_main_logo_img' src={`${process.env.PUBLIC_URL}/img/kream-logo1.png`}></img>
